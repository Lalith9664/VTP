...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      toast.info("Supabase credentials not configured in local environment. Proceeding in offline mock mode.");
      updateProfile({ fullName: "Guest User", email: "guest@university.edu" });
  ...
  const handleCreateAccount = () => {
    toast.info("Account creation is pre-loaded in this sandbox. Redirecting to onboarding...");
    router.push("/onboarding");
  };
      ...
      <div className="lg:col-span-6 flex flex-col items-center justify-center p-8 z-10">
        <div className="w-full max-w-[400px] flex flex-col items-start gap-8 text-left lg:-translate-x-12">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-slate-400 text-xs font-semibold">Access your agent automated profile matching dashboard.</p>
          </div>

          {/* Login Form Card - Neumorphic Card */}
          <div className="w-full neu-card p-8 rounded-3xl flex flex-col gap-6 relative border-none">
            
            {/* Supabase Google Authentication Button */}
            <button
              type="button"
            ...
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24" width="24" height="24" strokeWidth="0" fill="currentColor">
            ...
            <div className="flex items-center gap-2.5 my-1">
              ...
              <span className="text-[10px] text-slate-400 uppercase tracking-widest font-black">Or Sign In Offline</span>
              <div className="h-px bg-slate-800/45 flex-1" />
            </div>
